...
def parse_opts():
    ...
    parser.add_argument(
        '--video_path',
        default='test_data/gray_testdata11',
        type=str,
        help='Directory path of Videos')
    parser.add_argument(
        '--annotation_path',
        default='test_data/gray_test11/ucf101_01.json',
        type=str,
        help='Annotation file path')
    parser.add_argument(
        '--result_path',
        default='night_train_result/results_0525/',
        type=str,
    ...
    parser.add_argument(
        '--resume_path',
        default='night_train_result/results_0525/best.pth',
        type=str,
    ...
    parser.set_defaults(test_weight=True)
